...
SPForwardDynamicsABM::SPForwardDynamicsABM(DyBodyPtr body) :
...
SPForwardDynamicsABM::~SPForwardDynamicsABM()
{

}


void SPForwardDynamicsABM::initialize()
{
...
inline void SPForwardDynamicsABM::calcABMFirstHalf()
{
    calcABMPhase1();
    calcABMPhase2Part1();
}
...
inline void SPForwardDynamicsABM::calcABMLastHalf()
{
    calcABMPhase2Part2();
    calcABMPhase3();
}
...
void SPForwardDynamicsABM::calcNextState()
{
...
void SPForwardDynamicsABM::calcMotionWithEulerMethod()
{
    calcABMLastHalf();
...
void SPForwardDynamicsABM::integrateRungeKuttaOneStep(double r, double dt)
{
    DyLink* root = body->rootLink();
...
void SPForwardDynamicsABM::calcMotionWithRungeKuttaMethod()
{
    DyLink* root = body->rootLink();
...
void SPForwardDynamicsABM::calcABMPhase1()
{
...
void SPForwardDynamicsABM::calcABMPhase2()
{
    const LinkTraverse& traverse = body->linkTraverse();
    const int n = traverse.numLinks();
...
void SPForwardDynamicsABM::calcABMPhase2Part1()
{
    const LinkTraverse& traverse = body->linkTraverse();
    const int n = traverse.numLinks();
...
void SPForwardDynamicsABM::calcABMPhase2Part2()
{
    const LinkTraverse& traverse = body->linkTraverse();
    const int n = traverse.numLinks();
...
void SPForwardDynamicsABM::calcABMPhase3()
{
    const LinkTraverse& traverse = body->linkTraverse();
...
void SPForwardDynamicsABM::updateForceSensors()
{
